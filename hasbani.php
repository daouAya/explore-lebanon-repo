...
<div class="slideshow-container">
  ...
  <div class="mySlides fade">
    ...
    <img src="hasbani1.jpg" class="img">
    
  </div>

  <div class="mySlides fade">
    <div class="numbertext">2 / 3</div>
    <img src="hasbani2.jpg" class="img">
...
Embark on an adventure to the enchanting Hasbani River in Lebanon! Nestled amidst captivating landscapes, this river offers <br>
a tranquil haven for nature enthusiasts and explorers.<br>
 Immerse yourself in its serene waters and uncover the magic of this hidden gem.
          <div id="fact">
            <h3 class="candle">Did You Know?</h3>
            <br>
            <p>
            A fascinating fact about the Hasbani River is its rich history, mentioned in ancient texts and <br>
            playing a pivotal role in shaping the region's landscape.
...
Activities along the Hasbani River include swimming, kayaking, riverside picnics, hiking, and birdwatching.
