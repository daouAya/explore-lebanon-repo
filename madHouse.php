...
<div class="slideshow-container">
  ...
  <div class="mySlides fade">
    ...
    <img src="mad1.jpg" class="img">
    
  </div>

  <div class="mySlides fade">
    <div class="numbertext">2 / 3</div>
    <img src="mad2.jpg" class="img">
...
<p class="description">
Mad House isn't just about the music; it's about the community that comes together to create unforgettable memories.<br>
 Whether you're celebrating a milestone, catching up with friends, or simply letting loose, Mad House provides a vibrant and<br>
  inclusive environment where everyone is welcome.
          ...
          Mad House Beirut isn't just a nightclub; it's an entertainment powerhouse, redefining the nightlife experience in <br>
          Beirut. From live performances by renowned artists to captivating themed nights and immersive events, Mad House offers<br>
           an array of entertainment options that cater to every taste and preference. Whether you're mesmerized by live music,<br>
            dazzled by theatrical performances, or enchanted by themed parties, Mad House promises an unforgettable night of <br>
            entertainment that will leave you craving more.
          </p>
           <p>Location</p>
           <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3311.6035120644297!2d35.53142407550971!3d33.89986377321477!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x151f3dcd5591858f%3A0xe17cbfdf2281853!2sMADHOUSE!5e0!3m2!1sen!2slb!4v1714579862307!5m2!1sen!2slb" class="map" width="500" height="350" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
          </div>
          <br>
              <button class="fav-btn" id="fav-btn" onclick="addToFavorites('The Mad House')" style= style="background-color:rgb(92, 0, 0) ;">Add to Favorites</button>
