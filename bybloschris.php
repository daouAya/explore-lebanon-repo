...
<div class="slideshow-container">
  ...
  <div class="mySlides fade">
    ...
    <img src="jounieh1.jpg" class="img">
    
  </div>

  <div class="mySlides fade">
    <div class="numbertext">2 / 3</div>
    <img src="jounieh2.jfif" class="img">
...
<br>
 ...
 <h1>Christmas at byblos</h1>
<h2> &nbsp; &nbsp;Byblos:<br>&nbsp; &nbsp; Christmas Magic in Byblos</h2>

<p class="description">
   

    Celebrate Christmas in Byblos amidst the ancient streets adorned with festive lights and decorations. <br>
    Experience the holiday magic with Christmas markets, concerts, and events, creating unforgettable memories in this enchanting coastal town.
          </p>
          <div id="fact">
            <h3 class="candle">Did You Know?</h3>
            <br>
            <p>Byblos, believed to be one of the oldest continuously inhabited cities in the world, has a rich history dating back over 7,000 years.
                 <br>
                 Its ancient ruins and archaeological sites provide a fascinating glimpse into the region's past, adding an extra layer of depth to the holiday festivities in this historic city.
          ...
          <p class="description">
            In Byblos, visitors can immerse themselves in the city's rich history by exploring ancient ruins and archaeological sites,<br>
            , including the Crusader Castle and Roman Amphitheater. Additionally,   <br>
            strolling through the charming Old Souk offers opportunities to discover unique souvenirs and locally-made products.

        </p>
           
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d13211.648146110054!2d35.6519282!3d34.123001599999995!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x151f5ca814ab769b%3A0xbe47735b265d616e!2sByblos!5e0!3m2!1sen!2slb!4v1714573691350!5m2!1sen!2slb" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
              <button class="fav-btn" id="fav-btn" onclick="addToFavorites('Christmas at byblos')" style="background-color:rgba(145, 236, 146, 0.688) ;">Add to Favorites</button>
